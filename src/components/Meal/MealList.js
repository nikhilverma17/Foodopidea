...
const MealList = ({ meals }) => {
  const [showMeals, setShowMeals] = useState(true); // State to manage visibility of meal list

  // Filter out meals that are beef, pork, or lamb
  const filteredMeals = meals.filter(mealItem => !['Beef', 'Pork', 'Lamb','Miscellaneous'].includes(mealItem.strCategory));
    ...
    <div className='section-wrapper'>
      <div className='container'>
        ...
        <div className='toggle-btn-wrapper'>
          <button className='toggle-btn' onClick={() => setShowMeals(!showMeals)}>
